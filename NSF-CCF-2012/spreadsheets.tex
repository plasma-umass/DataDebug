...
\includegraphics[width=5.5in]{images/frequency-formulas}
  \caption{The frequency of formulas over ranges, across the entire EUSES repository. SUM dominates and other well-behaved functions like AVERAGE and PRODUCT are also common, demonstrating ample opportunity for our proposed optimization.\label{fig:frequency_formulas}}
\end{figure*}

To evaluate the opportunity for this optimization, we wrote a tool to
count the occurrences of functions over ranges from all the
spreadsheets in the EUSES repository (approximately
5,000). Figure~\ref{fig:frequency_formulas} presents the results. As
the figure shows, uses of the SUM function dominate all other
functions.  Two other common functions are average and product, both
of which are amenable to our proposed optimization.
