...
into MapReduce tasks. This work will make it possible for data
debugging to detect likely errors as soon as they are entered, or to
withstand errors automatically.

\begin{table}[!t]
\centering
\begin{tabular}{l|l|c|c|c|c}
\textbf{Domain} & \textbf{Feature} & \textbf{Prior} & \textbf{Preliminary} & \textbf{Proposed} & \textbf{PIs} \\
\hline
