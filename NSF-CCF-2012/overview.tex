...
\begin{figure}[!t]
\centering
\subfigure[A sample spreadsheet showing a personal budget, with an unfortunate typographical error (see Section~\ref{sec:overview}).\label{fig:personal_budget}]{
...
This section outlines the algorithms that data debugging
...
We illustrate these algorithms with a running
