...
typographical error when the correct value is \texttt{12.34}. Such errors
can change data items by orders of magnitude. Unfortunately, manual data
auditing to find this kind of mistake is both onerous and does not
scale.
...
analysis and statistical analysis to find and rank data with an
