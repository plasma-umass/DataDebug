...
This paper then presents a data debugging tool called \checkcell{}
...
spreadsheet. This statistical approach corresponds to an approximation
of exact significance testing~\cite{}, and allows \checkcell{} to find
errors in distribution-free numeric and non-numeric data. \checkcell{}
then ranks by impact all data whose effect crosses a threshold of
unusualness. In the user interface, \checkcell{} colors these cells in
